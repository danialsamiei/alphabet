...
Microbenchmarks for the Alphabet Context Handshake hot path, route normalization, consent policy helpers, and the Adaptive Render Layer selector.
...
| `layer-selection` | `selectAdaptiveLayer` (`@alphabet/ui/runtime`) | < 0.1ms |
