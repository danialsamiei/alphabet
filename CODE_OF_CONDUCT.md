...
correctness, security, and privacy bars (`AGENTS.md`).

AI agents must not:

- Bypass the consent ladder, DNT/GPC handling, or domain isolation rules
  documented in [`docs/SECURITY.md`](docs/SECURITY.md).
- Persist PII or precise geolocation in logs, telemetry, or error reports.
- Modify `AGENTS.md` or files under `.github/agents/` without explicit human
  approval.
