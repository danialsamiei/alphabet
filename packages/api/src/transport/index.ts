 ...
 * @module transport
 * @description
 * Internal transport primitives for `@awaf/api`.
 *
 * The public `AwafClient` accepts an optional `TransportPolicy` that wraps
 ...
 * `@awaf/api/transport` subpath for advanced consumers, but the default
 * public surface remains the existing `AwafClient` class.
 */
