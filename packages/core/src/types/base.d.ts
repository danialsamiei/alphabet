...
export declare const CONSENT_TIER_LEVEL: Record<ConsentTier, number>;
/**
...
export declare const TRUST_TIER_COEFFICIENT: Record<TrustTier, number>;
/**
 ...
 */
export type CapabilityLayer = 'R3F_IMMERSIVE' | 'CSS_3D' | 'CANVAS_2D' | 'STATIC_HTML' | 'TEXT_ONLY';
/** ترتیب عددی هر Layer برای مقایسه (کمتر = بهتر) */
export declare const CAPABILITY_LAYER_LEVEL: Record<CapabilityLayer, number>;
/**
...
export declare const TOKEN_TIER_LIMITS: Record<TokenTier, number>;
/**
 ...
 */
export type HandshakeState = 'idle' | 'detect' | 'enrich' | 'decide' | 'display' | 'consent' | 'morph' | 'runtime' | 'error';
